...
class ST_GAT(nn.Module):
    def __init__(self, input_size, output_size, n_nodes, heads=4, dropout=0.2, initialize = False):
        ...
        self.gat = GAT(input_size, 64, n_nodes, dropout, dropout, heads)
...
if __name__ == "__main__":
    test_stgat = ST_GAT(input_size=24, output_size=8, n_nodes=8)
    test_op = test_stgat(x = th.randn(32, 8, 24), adj = torch.ones(32, 8, 8))
    print(test_op)