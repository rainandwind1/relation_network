...
class EpisodeRunner:
    ...
    def run(self, test_mode=False, log_blood = False):
        self.reset()
        ...
        while not terminated:
            ...
            epi_blood_list.append(self.env.get_avg_own_blood())
            epi_enemy_blood_list.append(self.env.get_avg_enemy_blood())
        ...
        if test_mode and log_blood:
            np.save('./MMM2_ma_blood.npy', epi_blood_list)
            np.save('./MMM2_ma_enemy_blood.npy', epi_enemy_blood_list)
